...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/24 14:01:15 by tkeynes           #+#    #+#             */
/*   Updated: 2018/02/24 14:02:40 by tkeynes          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_insert_top(t_list **a_stack, t_list **b_stack)
{
	...
	nb_rotation = 1;
	while (*a_stack && *b_stack && *((int *)(*a_stack)->data) <
*((int *)(*b_stack)->data))
	{
		nb_rotation++;
...
void	ft_insert_bottom(t_list **a_stack, t_list **b_stack)
{
	...
	while (nb_rotation--)
	{
		if (*a_stack && *b_stack && (*((int *)(*b_stack)->data) -
*((int *)ft_list_last(*a_stack)->data) == 1))
		{
			ft_op("pa", a_stack, b_stack, 1);
			ft_op("ra", a_stack, b_stack, 1);
		}
